...
class PathingFSFSBumptoBump(commands2.SequentialCommandGroup):
    def __init__(self, container, indent=0) -> None:
        super().__init__()
        self.set_name(f'PathingFSFSBump-to-Bump')
        ...
        self.add_commands(
            ConditionalCommand(
                AutoBuilder.followPath(PathPlannerPath.fromPathFile('Right_Bump_to_Bump')),
                AutoBuilder.followPath(PathPlannerPath.fromPathFile('Left_Bump_to_Bump')),
                self.get_is_right
            )
