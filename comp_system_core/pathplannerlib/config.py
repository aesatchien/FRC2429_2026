...
from wpimath import DifferentialDriveKinematics, SwerveDrive4Kinematics, SwerveModuleVelocity, ChassisVelocities, \
...
class RobotConfig:
    ...
    def toSwerveModuleVelocities(self, speeds: ChassisVelocities) -> List[SwerveModuleVelocity]:
        ...
        if self.isHolonomic:
            ...
            return [
                SwerveModuleVelocity(wheelSpeeds.left, Rotation2d()),
    ...
    def chassisForcesToWheelForceVectors(self, chassisForces: ChassisVelocities) -> List[Translation2d]:
        """
        Convert chassis forces (passed as ChassisVelocities) to individual wheel force vectors
