...
class PathPlannerPath:
    ...
    def _loadChoreoTrajectoryIntoCache(trajectory_name: str) -> None:
        ...
        with open(filePath, 'r') as f:
            ...
            for s in trajJson['samples']:
                ...
                state.fieldSpeeds = ChassisVelocities(xVel, yVel, angularVelRps)
    ...
    def generateTrajectory(self, starting_speeds: ChassisVelocities, starting_rotation: Rotation2d,
        ...
        if self._idealTrajectory is not None:
            ...
            mirroredTraj = PathPlannerTrajectory(None, None, None, None, states=[
                PathPlannerTrajectoryState(
                    ...
                    fieldSpeeds=ChassisVelocities(s.fieldSpeeds.vx, -s.fieldSpeeds.vy, -s.fieldSpeeds.omega),
