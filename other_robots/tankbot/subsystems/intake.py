...
class Intake(Subsystem):
    def __init__(self) -> None:
        super().__init__()
        self.setName('Intake')
        self.counter = ic.k_flywheel_counter_offset  # note this should be an offset in constants
        ...
        self.configs = ic.k_flywheel_configs + [ic.k_indexer_config]  # FIXME - make this consistent
        ...
        SmartDashboard.putBoolean('intake_on', self.shooter_on)
    ...
    def periodic(self) -> None:
        ...
        if self.counter % 20 == 0:
            SmartDashboard.putNumber('intake_position', self.intake_encoder.getPosition())
            # not too often
