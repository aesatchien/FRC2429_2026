...
class ShootingFeedingCommand(commands2.Command):  # change the name for your command
    ...
    def initialize(self) -> None:
        ...
        self.shooter.set_shooter_rpm(self.rpm)
    ...
    def execute(self) -> None:
        ...
        self.shooter.set_shooter_rpm(rpm)

        # Latch the start of the feeding sequence
        if self.indexer_started_cycle < 0 and (self.counter > self.delay_cycles):
        ...
        if self.indexer_started_cycle > 0:
            self.shooter.set_indexer_rpm(sc.k_max_indexer_rpm)
